export const APP_FLAG_DEBUG = true;
export const APP_FLAG_DEBUG_VERBOSE = false;

export const APP_TITLE = 'React Broadcasting';

export const LOG_MAX_MESSAGES = 2;
...
export const URL_HOSTNAME_CONFIG = 'checkip.amazonaws.com';
export const URL_PATH_CONFIG = '/';
